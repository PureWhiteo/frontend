<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="小测验时长(分钟)" prop="time">
          <el-input v-model="ruleForm.time" 
              placeholder="小测验时长(分钟)" clearable  :readonly="ro.time"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="小测验时长(分钟)" prop="time">
              <el-input v-model="ruleForm.time" 
                placeholder="小测验时长(分钟)" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	status : false,
      ...
      rules: {
          ...
          time: [
                { required: true, message: '小测验时长(分钟)不能为空', trigger: 'blur' },
